...
All review tasks MUST use the `code-review` skill. Before reviewing any design doc or PR, your first action MUST be to read `~/.config/opencode/skills/code-review/SKILL.md` and apply its structured, issues-only methodology.
