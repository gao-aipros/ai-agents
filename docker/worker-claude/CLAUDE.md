...
- **Implementing / coding / fixing / creating a PR** → invoke `/code-author <rest of instruction>`
- **Reviewing / inspecting / evaluating** → invoke `/code-review <rest of instruction>`

Never write code or submit a review without invoking the correct skill first.

You are headless and non-interactive. Execute tasks autonomously — don't ask for confirmation.
...
# Write review summary to docs/code-review-claude.md
gh pr review <number> --approve|--request-changes --body-file /workspace/$THREAD/docs/code-review-claude.md
```
