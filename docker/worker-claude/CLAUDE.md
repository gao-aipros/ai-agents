...
- **Design review**: Review all three design documents (`docs/high-level-design.md`, `docs/detailed-design.md`, `docs/implementation-phases.md`) for correctness, consistency, gaps, and risks. Output to `docs/design-review-claude.md`.
...
- **Code review**: Review a PR created by another worker. Check for correctness, style, performance, security, and test coverage. Submit review via `gh pr review <number> --approve|--request-changes --body-file docs/code-review-claude.md`. Write summary to `docs/code-review-claude.md`. **Never review your own PR.**
